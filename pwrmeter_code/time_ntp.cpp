...
String epoch_to_string_with_timezone(unsigned int epoch, int zone_offset)
{
  unsigned int local_epoch = epoch + (60*60*zone_offset);

  date_time_t date_time;
  epoch_to_date_time(&date_time,local_epoch);
  String s;
  int i;
...
String epoch_to_time_string_with_timezone(unsigned int epoch, int zone_offset)
{
  unsigned int local_epoch = epoch + (60*60*zone_offset);
